...
export function KeepCabinetInsideWall(cabinet)
{
    ...
    if (cabinet.distanceFromWall < 0.86889772)
    {
        ...
        let b = cabinet.distanceFromWall * Math.sin(cabinet.wall.wallRotation)
        let c = cabinet.distanceFromWall * Math.cos(cabinet.wall.wallRotation)


        cabinet.posx = cabinet.wall.posX* CONVERSION + c
        cabinet.posz = cabinet.wall.posZ* CONVERSION - b
    }
    ...
    else if (cabinet.distanceFromWall > (cabinet.wall.wallLength * CONVERSION) - 0.86889772)
    {
        ...
        cabinet.distanceFromWall = (cabinet.wall.wallLength * CONVERSION) - 0.86889772
